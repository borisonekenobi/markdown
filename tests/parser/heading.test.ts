...
describe('Heading', () => {
	test('parses h1 correctly', async () => {
		...
		expect(output).toBe('<h1>Heading level 1</h1>');
	});
	...
	test('parses h2 correctly', async () => {
		...
		const vfile = await parse(input);
		const output = vfile.toString();
		expect(output).toBe('<h2>Heading level 2</h2>');
	});
	...
	test('parses h3 correctly', async () => {
		...
		const vfile = await parse(input);
		const output = vfile.toString();
		expect(output).toBe('<h3>Heading level 3</h3>');
	});
	...
	test('parses h4 correctly', async () => {
		...
		const vfile = await parse(input);
		const output = vfile.toString();
		expect(output).toBe('<h4>Heading level 4</h4>');
	});
	...
	test('parses h5 correctly', async () => {
		...
		const vfile = await parse(input);
		const output = vfile.toString();
		expect(output).toBe('<h5>Heading level 5</h5>');
	});
	...
	test('parses h6 correctly', async () => {
		...
		const vfile = await parse(input);
		const output = vfile.toString();
		expect(output).toBe('<h6>Heading level 6</h6>');
	});
	...
	test.each([
		...
		const vfile = await parse(markdown);
		const output = vfile.toString();
