...
describe('Different Inner Elements', () => {
	test('simple', async () => {
		const input = '<p>Here\'s a simple footnote, <sup><a href="#user-content-fn-1" id="user-content-fnref-1" data-footnote-ref="" aria-describedby="footnote-label">1</a></sup>.</p>\n' +
			'<section data-footnotes="" class="footnotes"><h2 class="sr-only" id="footnote-label">Footnotes</h2>\n' +
			'<ol>\n' +
			'<li id="user-content-fn-1">\n' +
			'  <p>Hello world</p>\n' +
